...
function ExpensePage() {
  ...
  return (
    <>
      <Navbar />
      <div  class="bg-gradient-to-r from-red-300 to-gray-600 flex flex-row">
        <div class="flex flex-col">
          <div class="w-72  m-10 h-96 max-w-sm p-4  rounded-lg shadow sm:p-8 bg-gradient-to-r from-red-300 to-gray-600 ">
            ...
            <div class="flex ml-2 items-baseline text-gray-900 dark:text-white">
              ...
              <span class="text-5xl font-extrabold tracking-tight">
                ...
                <span class="text-5xl font-extrabold tracking-tight">{totalBalance*-1}</span>
              </div>:
              <div class="flex ml-4 items-baseline text-gray-900 dark:text-white">
              <span class="text-3xl font-semibold">₹</span>
              <span class="text-5xl font-extrabold tracking-tight">{totalBalance}</span>
            </div>
}
              </span>
            </div>
        ...
        <div class="w-full m-20 max-w-xs">
          <form
            onSubmit={onSubmit}
        ...
        <div class="w-full m-10 h-96  max-w-md bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
